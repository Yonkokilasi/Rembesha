...
import com.example.bubbles.rembesha.MainActivity;
...
public class CreateAccountActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void createAuthProgessDialog() {
        ...
        mAuthProcessDialog.setTitle("Traveling the makeup store");
        mAuthProcessDialog.setMessage("Authenticating your credentials.Ngoja Kidogo...");
    ...
    private boolean isValidPassword(String password,String confirmPassword) {
        if (password.length() < 7) {
            mPassword.setError("Please enter a password containing atleast 8 characters and one uppercase Letter");
            return false;
